...
namespace vl
{
    ...
    void Vulkan::createInstance()
    {
        ...
        appInfo.engineVersion = settings.engineVersion;
        appInfo.apiVersion = settings.apiVersion;
    ...
    void Vulkan::createSwapChain()
    {
        ...
        std::cout << "Vulkan: swap chain successfully created!" << std::endl;
    }
    ...
    void Vulkan::createImageViews()
    {
        ...
        std::cout << "Vulkan: image views successfully created!" << std::endl;
    }
    ...
    void Vulkan::createGraphicsPipeline()
    {
        ...
        std::cout << "Vulkan: graphics pipeline layout successfully created!" << std::endl;
        ...
        std::cout << "Vulkan: graphics pipeline successfully created!" << std::endl;
    ...
    void Vulkan::createFramebuffers()
    {
        ...
        std::cout << "Vulkan: frame buffer successfully created!" << std::endl;
    }
    ...
    void Vulkan::createCommandPool()
    {
        ...
        std::cout << "Vulkan: command pool successfully created!" << std::endl;
    }
    ...
    void Vulkan::createCommandBuffer()
    {
        ...
        std::cout << "Vulkan: command buffer successfully created!" << std::endl;
    }
    ...
    void Vulkan::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
    {
        ...
        std::cout << "Vulkan: command buffer successfully recorded!" << std::endl;
    }
